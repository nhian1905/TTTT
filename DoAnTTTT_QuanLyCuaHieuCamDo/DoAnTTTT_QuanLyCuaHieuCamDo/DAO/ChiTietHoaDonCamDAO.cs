...
namespace DoAnTTTT_QuanLyCuaHieuCamDo.DAO
{
    public class ChiTietHoaDonCamDAO
    {
        ...
        public List<ChiTietHoaDonCamDTO> LoadListCTHDC(int MaHoaDonCam)
        {
            ...
            string query = "select c.MaHoaDonCam, a.MaSP,b.TenLoai,a.TenSP,a.DinhGia,a.GiaThanhLy,a.MoTa,a.MauSac,a.HienTrang, a.NhangHieu from SanPham a , LoaiSP b , ChiTiet_HoaDonCam c, HoaDonCam d where a.MaLoai = b.MaLoai and a.MaSP = c.MaSP and c.MaHoaDonCam = d.MaHoaDonCam and a.ThanhLy=0 and a.DaThanhLy=0 and a.DaChuoc=0 and a.QuaHan=0 and c.MaHoaDonCam  = " + MaHoaDonCam;
